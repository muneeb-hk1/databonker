...
<div class="container form-box mb-3">
    <div class="row">
        <div class="em_ver">
        ...
        <div class="col-sm-12 col-md-6">
            ...
            <h2 class="mb-4">Enter Your OTP 
                    <br>
                    We send on your email.
                </h2>   
                    <form action="#" method="post">
                    <label for="number">Enter Your OTP</label>
                    <input type="number" placeholder="#8765" required>
